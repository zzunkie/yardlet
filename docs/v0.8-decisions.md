...
- **Branch** `v0.8-finalize-run`. Foundation slices 1–1d landed (`33950d1` →
  ...
  1e), `e4ef54e` (recovery telemetry, 1e), and `7f55e13` (Project Memory MVP, 2).
  **125 tests green**, fmt + clippy `-D warnings` clean. The 2026-06-23 feature
  commits + their docs are **LOCAL, not pushed**.
