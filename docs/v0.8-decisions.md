...
- **Slice 1e** — close the two gaps the map revealed: parallel runs no validation;
  recovery records no telemetry/handoff.
...
- **Branch** `v0.8-finalize-run`. Commit `33950d1` = finalize_run extracted + serial
  wired; 115 tests green, fmt/clippy clean. **Not pushed.**
