...
pub struct L {
    ...
    pub footer_monitor_diagnostic: &'static str,
    pub monitor_no_runs: &'static str,
    pub monitor_no_failed_attempt: &'static str,
    pub monitor_attempt: &'static str,
    pub monitor_exit: &'static str,
    pub monitor_stdout: &'static str,
    pub monitor_stderr: &'static str,
    pub monitor_none: &'static str,
    pub monitor_empty_stream: &'static str,
    pub monitor_read_failed: &'static str,
    ...
    pub planning_start_failed: &'static str,
    pub planning_start_fallback: &'static str,
    pub planning_started: &'static str,
...
pub const EN: L = L {
    ...
    key_doc_monitor: "inspect a selected failure or follow live worker output",
    ...
    footer_monitor_diagnostic: "\u{2191}\u{2193}/PgUp/PgDn scroll \u{00b7} Esc/q back",
    monitor_no_runs: "No runs yet. Press r or A on Home to start one.",
    monitor_no_failed_attempt: "No failed attempt was recorded for the selected task in the current intent.",
    monitor_attempt: "Attempt",
    monitor_exit: "Exit",
    monitor_stdout: "stdout",
    monitor_stderr: "stderr",
    monitor_none: "none",
    monitor_empty_stream: "(empty stream)",
    monitor_read_failed: "read failed",
    ...
    footer_planning_review: "\u{2191}/\u{2193}/PgUp/PgDn scroll  s start  a accept  r reject  Tab target  e revise  c confirm  g refresh  Esc/q back",
    footer_planning_review_busy: "planning/start in progress...  Esc/q back",
    ...
    planning_start_failed: "Start refused:",
    planning_start_fallback: "Use the detailed actions on this review screen.",
    planning_started: "Exact plan confirmed; queue drain stopped",
...
pub const KO: L = L {
    ...
    key_doc_monitor: "선택한 실패 원문 확인 또는 워커 실시간 출력 따라가기",
    ...
    footer_monitor_diagnostic: "\u{2191}\u{2193}/PgUp/PgDn 스크롤 \u{00b7} Esc/q 뒤로",
    monitor_no_runs: "아직 실행 없음. Home 에서 r 또는 A 로 시작.",
    monitor_no_failed_attempt: "현재 intent의 선택 작업에 기록된 실패 시도가 없습니다.",
    monitor_attempt: "시도",
    monitor_exit: "종료",
    monitor_stdout: "stdout",
    monitor_stderr: "stderr",
    monitor_none: "없음",
    monitor_empty_stream: "(빈 스트림)",
    monitor_read_failed: "읽기 실패",
    ...
    footer_planning_review: "\u{2191}/\u{2193}/PgUp/PgDn 스크롤  s 시작  a 수락  r 거절  Tab 대상  e 수정  c 확정  g 새로고침  Esc/q 뒤로",
    footer_planning_review_busy: "플랜 처리/시작 중...  Esc/q 뒤로",
    ...
    planning_start_failed: "빠른 시작 거절:",
    planning_start_fallback: "이 검토 화면의 상세 동작을 사용하세요.",
    planning_started: "정확한 플랜을 확정했으며 큐 드레인이 멈춤",
    planned_via: "계획 완료 ·",
    tasks_word: "개 작업",
