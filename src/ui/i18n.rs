...
pub const EN: L = L {
    ...
    run_word: "running",
    sec_unit: "s",
    subscription_note: "   running your own CLI \u{2014} no extra billing",
    idle: " idle",
    update_ready: " \u{2B06} new yard build installed \u{2014} press u to restart into it",
    needs_you: "needs you",
    press_a: "  (press a)",
    see_handoff: "see handoff",
    footer_home: "\u{2191}\u{2193}/Enter view task  n new  r run  A auto  m monitor  h handoff  f access  s settings  l lang  g refresh  R reports  q quit",
...
pub const KO: L = L {
    ...
    run_word: "실행 중",
    sec_unit: "초",
    subscription_note: "   쓰던 CLI 그대로 \u{2014} 추가 과금 없음",
    idle: " 대기",
    update_ready: " \u{2B06} 새 yard 빌드 설치됨 \u{2014} u 누르면 재시작해서 반영",
    needs_you: "응답 필요",
    press_a: "  (a 키)",
    see_handoff: "핸드오프 참고",
    footer_home: "\u{2191}\u{2193}/Enter 태스크 보기  n 새작업  r 실행  A 자동  m 모니터  h 핸드오프  f 권한  s 설정  l 언어  g 새로고침  R 보고  q 종료",
    footer_home_busy: "실행 중...  p 일시정지  Esc 정지  m 모니터  h 핸드오프  f 권한  s 설정  q 종료",
    key_answer: "a 답변",
    key_approve: "p 승인",
    busy: "워커 실행 중 · 잠시만요",
