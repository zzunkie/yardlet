...
pub const EN: L = L {
    ...
    footer_home: "\u{2191}\u{2193}/Enter view task  n new  r run  A auto  m monitor  h handoff  f access  s settings  l lang  g refresh  q quit",
...
pub const KO: L = L {
    ...
    press_a: "  (a 키)",
    see_handoff: "핸드오프 참고",
    footer_home: "\u{2191}\u{2193}/Enter 태스크 보기  n 새작업  r 실행  A 자동  m 모니터  h 핸드오프  f 권한  s 설정  l 언어  g 새로고침  q 종료",
