...
pub const EN: L = L {
    ...
    footer_home: "\u{2191}\u{2193}/Enter view task  n new  r run  A auto  a answer  p approve  m monitor  h handoff  f access  s settings  l lang  g refresh  q quit",
    footer_home_busy: "running...  p pause  Esc stop  m monitor  h handoff  f access  s settings  q quit",
    ...
    footer_monitor: "Esc/q back \u{00b7} live worker output",
...
pub const KO: L = L {
    ...
    press_a: "  (a 키)",
    see_handoff: "핸드오프 참고",
    footer_home: "\u{2191}\u{2193}/Enter 태스크 보기  n 새작업  r 실행  A 자동  a 답변  p 승인  m 모니터  h 핸드오프  f 접근  s 설정  l 언어  g 새로고침  q 종료",
    footer_home_busy: "실행 중...  p 일시정지  Esc 정지  m 모니터  h 핸드오프  f 접근  s 설정  q 종료",
    busy: "워커 실행 중 · 잠시만요",
    ...
    footer_monitor: "Esc/q 뒤로 \u{00b7} worker 실시간 출력",
