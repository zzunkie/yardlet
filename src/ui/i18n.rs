...
pub struct L {
    ...
    pub parallel_ready_label: &'static str,
    pub sequential_label: &'static str,
    pub parallel_fix_label: &'static str,
    pub parallel_running_label: &'static str,
    pub seq_parallel_disabled: &'static str,
    pub fix_parallel_disabled: &'static str,
    pub seq_runnable_count: &'static str,
    pub fix_runnable_count: &'static str,
    pub seq_dependency_chain: &'static str,
    pub fix_dependency_chain: &'static str,
    pub seq_approval_required: &'static str,
    pub fix_approval_required: &'static str,
    pub seq_validation_required: &'static str,
    pub fix_validation_required: &'static str,
...
pub const EN: L = L {
    ...
    parallel_ready_label: "Parallel ready",
    sequential_label: "Sequential now",
    parallel_fix_label: "To parallel",
    parallel_running_label: "Running in parallel",
    seq_parallel_disabled: "parallel disabled",
    fix_parallel_disabled: "set Settings > Parallel tasks above 1",
    seq_runnable_count: "fewer than two runnable independent tasks",
    fix_runnable_count: "add or unblock another independent queued task",
    seq_dependency_chain: "dependency chain",
    fix_dependency_chain: "split truly independent work or finish dependencies first",
    seq_approval_required: "approval required",
    fix_approval_required: "approve the marked tasks",
    seq_validation_required: "validation-required task",
    fix_validation_required: "run it serially or split validation-free independent work",
...
pub const KO: L = L {
    ...
    tag_input: "입력",
    tag_approval: "승인",
    parallel_ready_label: "병렬 가능",
    sequential_label: "현재 순차",
    parallel_fix_label: "병렬 처방",
    parallel_running_label: "병렬 실행 중",
    seq_parallel_disabled: "병렬 꺼짐",
    fix_parallel_disabled: "설정 > 병렬 작업 수를 2 이상으로 올리세요",
    seq_runnable_count: "실행 가능한 독립 작업이 2개 미만",
    fix_runnable_count: "다른 독립 대기 작업을 추가하거나 막힌 작업을 풀어주세요",
    seq_dependency_chain: "의존 체인",
    fix_dependency_chain: "진짜 독립 작업은 의존을 나누거나 먼저 의존 작업을 완료하세요",
    seq_approval_required: "승인 필요",
    fix_approval_required: "표시된 작업을 승인하세요",
    seq_validation_required: "검증 필수 작업",
    fix_validation_required: "순차로 실행하거나 검증 없는 독립 작업으로 분리하세요",
    workers_title: " 워커 ",
    w_ready: "호출가능",
    w_ambiguous: "모호",
    w_notready: "준비안됨",
